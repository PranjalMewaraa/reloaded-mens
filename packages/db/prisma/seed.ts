...
const PRODUCTS: SeedProduct[] = [
  ...
  },
  {
    ...
    description:
      'Double-pleat linen pant with a generous leg and a turn-up hem. Lightweight enough for a Delhi summer; structured enough to dress up.',
  ...
  },
  {
    ...
    description:
      'A hand-block printed kurta in mul cotton, finished with mother-of-pearl buttons. Available made-to-measure at our Ghaziabad store. Book a fitting on WhatsApp to choose the print and fit.',
      ...
      if (orderItem) {
        await prisma.review.create({
          data: {
            ...
            body: 'Boxy in the right places, just the right weight for Delhi summer. Sized down half — TTS for an oversized look.',
            status: 'approved',
            approvedAt: new Date(),
          },
        });
